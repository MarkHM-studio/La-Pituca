...
@WebMvcTest(TipoJornadaController.class)
@Import(SecurityConfig.class)
class TipoJornadaControllerIntegrationTest {
    ...
    // 🔹 Helper
    private TipoJornadaResponse mockResponse() {
    ...
    void crear_deberiaRetornar201() throws Exception {
        ...
        when(tipoJornadaService.guardar(any()))
                .thenReturn(mockResponse());

        mockMvc.perform(post("/api/tipoJornada")
    ...
    void crear_deberiaRetornar403() throws Exception {
        ...
        verify(tipoJornadaService, never()).guardar(any());
    }
    ...
    void listarTodos_deberiaRetornar200() throws Exception {
        ...
        when(tipoJornadaService.listarTodos())
                .thenReturn(List.of(mockResponse()));

        mockMvc.perform(get("/api/tipoJornada"))
    ...
    void obtenerPorId_deberiaRetornar200() throws Exception {
        ...
        when(tipoJornadaService.obtenerPorId(1L))
                .thenReturn(mockResponse());

        mockMvc.perform(get("/api/tipoJornada/1"))
                .andExpect(status().isOk())
    ...
    void obtenerPorId_deberiaRetornar400_cuandoIdInvalido() throws Exception {
        ...
        mockMvc.perform(get("/api/tipoJornada/0"))
    ...
    void actualizar_deberiaRetornar200() throws Exception {
        ...
        when(tipoJornadaService.actualizar(any(), any()))
                .thenReturn(mockResponse());

        mockMvc.perform(put("/api/tipoJornada/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                                {
                                  "nombre": "Turno Tarde"
    ...
    void eliminar_deberiaRetornar204() throws Exception {
        ...
        mockMvc.perform(delete("/api/tipoJornada/1"))
